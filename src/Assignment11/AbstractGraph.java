 ...
 abstract class AbstractGraph<V> implements Graph<V> {
    ...
    protected AbstractGraph(V[] vertices, int[][]edges) {
        for (int i = 0; i < vertices.length; i++)
            addVertex(vertices[i]); //goes through given vertices and adds them to graph

        createAdjacencyLists(edges, vertices.length); //creates lists out of edges given
    }
...
/** To be discussed in Section 28.7 */
  ...
  // Recursive Method that will not be used.
     ...
     */
//    private void dfs(int u, int[] parent, List<Integer> searchOrder, boolean[] isVisited) { //Iterative approach without recursion
